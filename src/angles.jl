...
struct WrappedInterpolatedBrownianDiffusion{T <: Real} <: WrappedDiffusion{T}
    rate::T
end
...
function wrapped_combine_and_sample(rng::AbstractRNG, P::WrappedBrownianDiffusion, mu::T, var::T, back_mu::T, back_var::T) where T
...
function wrapped_combine_and_sample(rng::AbstractRNG, P::WrappedInterpolatedBrownianDiffusion, mu::T, var::T, back_mu::T, back_var::T) where T
